...
def detect_sleep(
    ...
    2. bbox의 가로/세로 비율(aspect ratio)이 aspect_ratio_threshold 이상 (누운 자세)
    ...
    Args:
        ...
        aspect_ratio_threshold: float
            bbox 가로/세로 비율 임계값 (이 값 이상이면 누운 자세로 판단)
    ...
    for id in sleep_coor.keys():
        ...
        aspect_ratios = widths[valid] / heights[valid]
